...
frailty = read.csv("/Users/dheerajreddy/Downloads/PDS_UMKC-main/PDS/Assignment/1.1/data_raw/raw_frailty_data1.csv")
frailty
...
write.csv(frailty, "/Users/dheerajreddy/Downloads/PDS_UMKC-main/PDS/Assignment/1.1/data_clean/clean_frailty_data.csv")
