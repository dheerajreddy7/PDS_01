...
Student = read.csv("/Users/dheerajreddy/Downloads/PDS_UMKC-main/PDS/Assignment/1.2/data_clean/Clean_StudentsData.csv")
Student
...
plot(Student_Data$gender, Student_Data$reading.score,
     xlab = "SEX", ylab = "READING SCORE",main="BOXPLOTS OF READING SCORE VS GENDER",col.main="red", col=(c("blue","green")))

#2.3
Student_Data$gender <- as.factor(Student_Data$gender)
plot(Student_Data$gender, Student_Data$writing.score,
     xlab = "SEX", ylab = "WRITING SCORE",main="BOXPLOTS OF WRITING SCORE VS GENDER",col.main="red", col=(c("pink","blue")))
