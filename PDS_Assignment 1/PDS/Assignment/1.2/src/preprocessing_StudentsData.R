...
Student = read.csv("/Users/dheerajreddy/Downloads/PDS_UMKC-main/PDS/Assignment/1.2/data_raw/Raw_StudentsPerformance.csv")
Student
...
#save the clean Data
write.csv(Student_Data, "/Users/dheerajreddy/Downloads/PDS_UMKC-main/PDS/Assignment/1.2/data_clean/Clean_StudentsData.csv")
